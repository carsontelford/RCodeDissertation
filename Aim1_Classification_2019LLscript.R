...
output_folder <- "/users/c/t/ctelford/ClassificationOutput/Year2019/"
raster_folder <- "/users/c/t/ctelford/Rasters/Year2019/"
...
# 
# # save the stack
# rstack_file <- file.path(stack_folder, "rstack_Aggx2_2019.tif")
# writeRaster(
#   rstack,
#   rstack_file,
#   overwrite = TRUE,
...
myrstack_file
specificfile <- myrstack_file[grepl("2019", myrstack_file)]
