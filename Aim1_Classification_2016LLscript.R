...
output_folder <- "/users/c/t/ctelford/ClassificationOutput/Year2016/"
raster_folder <- "/users/c/t/ctelford/Rasters/Year2016/"
...
# 
# # save the stack
# rstack_file <- file.path(stack_folder, "rstack_Aggx2_2016.tif")
# writeRaster(
#   rstack,
#   rstack_file,
#   overwrite = TRUE,
...
myrstack_file
specificfile <- myrstack_file[grepl("2016", myrstack_file)]
