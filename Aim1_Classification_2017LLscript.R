...
output_folder <- "/users/c/t/ctelford/ClassificationOutput/Year2017/"
raster_folder <- "/users/c/t/ctelford/Rasters/Year2017/"
...
# 
# # save the stack
# rstack_file <- file.path(stack_folder, "rstack_Aggx2_2017.tif")
# writeRaster(
#   rstack,
#   rstack_file,
#   overwrite = TRUE,
...
myrstack_file
specificfile <- myrstack_file[grepl("2017", myrstack_file)]
