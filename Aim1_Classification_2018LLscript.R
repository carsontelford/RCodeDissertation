...
output_folder <- "/users/c/t/ctelford/ClassificationOutput/Year2018/"
raster_folder <- "/users/c/t/ctelford/Rasters/Year2018/"
...
# 
# # save the stack
# rstack_file <- file.path(stack_folder, "rstack_Aggx2_2018.tif")
# writeRaster(
#   rstack,
#   rstack_file,
#   overwrite = TRUE,
...
myrstack_file
specificfile <- myrstack_file[grepl("2018", myrstack_file)]
