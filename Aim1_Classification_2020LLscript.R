...
output_folder <- "/users/c/t/ctelford/ClassificationOutput/Year2020/"
raster_folder <- "/users/c/t/ctelford/Rasters/Year2020/"
...
# 
# # save the stack
# rstack_file <- file.path(stack_folder, "rstack_Aggx2_2020.tif")
# writeRaster(
#   rstack,
#   rstack_file,
#   overwrite = TRUE,
...
myrstack_file
specificfile <- myrstack_file[grepl("2020", myrstack_file)]
