...
output_folder <- "/users/c/t/ctelford/ClassificationOutput/Year2023/"
raster_folder <- "/users/c/t/ctelford/Rasters/Year2023/"
...
for (tile_path in tile_files) {
  ...
  # Build output filename by replacing "rstack_tile" with "classification_2023_tile"
