...
output_folder <- "/users/c/t/ctelford/ClassificationOutput/Year2022/"
raster_folder <- "/users/c/t/ctelford/Rasters/Year2022/"
...
# save the stack
rstack_file <- file.path(stack_folder, "rstack_Aggx2_2022.tif")
writeRaster(
  rstack,
  rstack_file,
  overwrite = TRUE,
...
myrstack_file
specificfile <- myrstack_file[grepl("2022", myrstack_file)]
